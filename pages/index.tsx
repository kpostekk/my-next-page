    ...
    <div>
      ...
      <div className="w-screen h-screen relative overflow-clip">
        ...
        <div className="w-full h-full absolute">
          <div className="w-full h-full flex flex-col justify-center p-4 md:p-36 items-start gap-2 select-none">
            <div className="backdrop-blur bg-gray-800 bg-opacity-60 md:p-12 p-8 rounded-xl text-white grid gap-4">
              ...
              <p className="select-text">JavaScript/TypeScript, Python, Docker, MongoDB, Postgres, GraphQL, Java</p>
            </div>
            <div className="flex flex-col md:flex-row items-start md:items-stretch gap-2">
              <div className="flex gap-6 items-center text-[24pt] backdrop-blur bg-gray-800 bg-opacity-60 p-6 rounded-xl text-white">
                <a className="hover:text-sky-500" href="https://github.com/kpostekk">
                  <TbBrandGithub />
                </a>
                <a className="hover:text-sky-500" href="https://www.linkedin.com/in/kpostekk/">
                  <TbBrandLinkedin />
                </a>
              </div>
              <div className="text-[18pt] backdrop-blur bg-gray-800 bg-opacity-60 p-6 rounded-xl text-white">
                <a href="/cv.pdf" className="hover:text-sky-500">
